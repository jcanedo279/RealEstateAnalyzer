...
def get_chrome_options(headless=False, incognito=False):
    ...
    if incognito:
        ...
        user_data_dir = "/Users/jorgecanedo/Library/Application Support/Google/Chrome for Testing"
...
def get_selenium_driver(url, headless=False, incognito=False):
    ...
    binary_executable_path = "GC_121_0_6167_85.app/Contents/MacOS/Google Chrome for Testing"
